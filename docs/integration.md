...
This project is host-agnostic. Invokr is the first consumer, but nothing below
assumes it. Pick the integration mode that matches how much lifecycle you want
to own.
