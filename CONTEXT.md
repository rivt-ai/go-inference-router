...
Invokr is the first such host; the contract, the runtime, and the `llm.v1`
protocol are deliberately host-agnostic.
...
_Avoid_: Client, consumer, Invokr (a specific host, not the role)
